$.intelurate.core.api.userGroup.getUserCollectionFromWeb = (function (options) {
	...
	$.ajax({
		...
		beforeSend: function (xhr) {
			xhr.setRequestHeader("SOAPAction", "http://schemas.microsoft.com/sharepoint/soap/directory/SPServiceGetUserCollectionFromWeb");
		},
		type: "POST",
		dataType: "xml",
		data: soapEnv,
